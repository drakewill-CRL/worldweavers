...
function _M:init(t, no_default)
	...
	--set default life here. I think this gets overriden by birth options and npc creation?
	--max life gets overridden by birth options,  life doesnt, NPCs seem to use this regardless of their settings?
	--vars are life and max_life

	self.upgrades = {} --starts empty.
