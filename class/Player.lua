...
function _M:init(t, no_default)
	...
	--self.charPoints = 3 -- you have 3 points for upgrades. Might make this selectable via birth option?
	self.combat.dam = 8 --Minimum Amberite damage
end
...
function _M:act()
	...
	--We only regain MP if we rest. We don't regen resources if we moved
	...
	if (win == true) then
		--player wins
		Dialog:simplePopup("Victory!", "You have slain your rival(s) and saved the multiverse!", winExit)
	end
end
